...
public class ClientUtils {
    ...
    /**
     * Get the name from function name e.g in case of 'state.high', this function will return state
     * @param functionName
     * @return module name
     * @throws IllegalArgumentException
     */
    public static String getModuleNameFromFunction(final String functionName) throws IllegalArgumentException {
